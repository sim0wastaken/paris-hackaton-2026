...
This project is indexed by GitNexus as **paris-hackaton-2026** (1564 symbols, 2233 relationships, 48 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
