...
This project is indexed by GitNexus as **paris-hackaton-2026** (992 symbols, 1064 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
